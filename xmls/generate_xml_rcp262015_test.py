...
def xmlgen():
  ...
  templatefile='./headers/dev_site_header_hadcm3.xml'
  #Output XML filename
  outxmlfile='./hadcm3s_rcp262015_test.xml'
  ...
  old_umids = ['zi73'] #Correct param umid for 723f
  ...
  outtreeroot.find('batch_tech_info').text = 'TCRE - testing RCP2.6-2015 ancils'
  outtreeroot.find('batch_proj').text = 'TCRE'
  outtreeroot.find('batch_desc').text = 'HadCM3S Testing'
  ...
  for file_so2dms in files_so2dms:
       ...
       param_data = param_dataset[param_dataset['umid']=='y'+old_umids[0][1:]]
       ...
       for theta in theta_list:
         ...
         try:
           ...
           SubElement(Parameters, 'file_atmos').text= '723f_2014.astart'
           SubElement(Parameters, 'file_ocean').text= '723f_2014.ostart'
